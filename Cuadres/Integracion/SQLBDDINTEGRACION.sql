...
IF OBJECT_ID ('dbo.rep_plazo_fijo') IS NOT NULL
                DROP TABLE dbo.rep_plazo_fijo
GO


CREATE TABLE dbo.rep_plazo_fijo
(
...
CREATE UNIQUE CLUSTERED INDEX rep_riesgo_liquidez_Key
ON dbo.rep_plazo_fijo (rf_fecha_carga,rf_prod_cobis, rf_cuenta, rf_cliente, rf_operacion) ON 'default'

GO

CREATE NONCLUSTERED INDEX rep_riesgo_liquidez_Key1
ON dbo.rep_plazo_fijo (rf_prod_cobis, rf_cuenta) ON 'default'
GO
